# Task 4 - Implement difficulty setting (in random game) which allows the user to add more "largeNums" to their allowed numbers list (8 marks)
...
def FillNumbers(NumbersAllowed, TrainingGame, MaxNumber):
    if TrainingGame:
        ...
        difficultyChoice = input("Enter difficulty: standard, easy, medium, hard: ").lower()

        if difficultyChoice == "standard":
            while len(NumbersAllowed) < 5:
                NumbersAllowed.append(GetNumber(MaxNumber))

        elif difficultyChoice == "easy":
            while len(NumbersAllowed) < 4:
                NumbersAllowed.append(GetNumber(MaxNumber))

            NumbersAllowed.append(largeNums[num1])
            ...
            NumbersAllowed.append(largeNums[num1])
            NumbersAllowed.append(largeNums[num2])
            ...
            NumbersAllowed.append(largeNums[num1])
            NumbersAllowed.append(largeNums[num2])
            NumbersAllowed.append(largeNums[num3])
            NumbersAllowed.append(largeNums[num4])
