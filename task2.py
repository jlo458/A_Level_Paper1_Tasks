# Task 2 - Develop error system which prints the various errors the user has made within their input (6 marks)
            ...
            try:
                ...
                if CheckNumbersUsedAreAllInNumbersAllowed(NumbersAllowed, UserInputInRPN, MaxNumber):
                    ...
                    if IsTarget:
                        ...
                        print("Input not a target!")

                else:
                    print("Does not include valid numbers!")

            except:
                print("Division by zero!")

        else:
            print("Not valid infix notation!")
...
def CheckIfUserInputValid(UserInput):
    if re.search("^([0-9]+[\\+\\-\\*\\/])+[0-9]+$", UserInput) is not None:
        ...
        print("Invalid input - incorrect infix notation!")
